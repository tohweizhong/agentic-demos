...
## Folders
* [a2a_adk_sample](./a2a_adk_sample/): Deploying an A2A-enabled ADK agent to Cloud Run and registering with Agentspace
* [a2a_from_scratch](./a2a_from_scratch/): Agent-to-Agent (A2A) protocol demo with purchasing concierge and remote seller agents
* [adk2_examples](./adk2_examples/): Key concepts and examples for Google Agent Development Kit (ADK) 2.0
* [adk_101](./adk_101/): ADK 101 training notebook for Vertex AI Workbench
* [adk_cloud_run](./adk_cloud_run/): Deploying ADK agents to Google Cloud Run
* [adk_mcp_explainer](./adk_mcp_explainer/): Secure MCP server and ADK Agent playground on Cloud Run
* [adk_multiagent](./adk_multiagent/): Multi-agent ADK example (Campaign Orchestrator, Creative Director, Financial Analyst)
...
* [ge_license_distribute](./ge_license_distribute/): Gemini Enterprise License Distribution Utility Scripts
...
* [nus-agy-workshop](./nus-agy-workshop/): NUS Campus Transit Hub & Telegram Bot workshop codelab built with Google Antigravity
