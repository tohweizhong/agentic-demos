...
## Phase 1: Multi-Probe Test Catalog & Unit Test Verification (TDD)
- [ ] Task: Update `test_cases/smoke_test_cases.json` to define all 3 smoke probes (`smoke_gdrive_01`, `smoke_deep_research_02`, `smoke_web_grounding_03`) with zero keywords and pure semantic contracts.
- [ ] Task: [TDD] Update `config_test.go` and `client_test.go` to verify 3-probe parsing and payload construction.
