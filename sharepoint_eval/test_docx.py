...
async def main():
    print("Initializing Agent Runner for DOCX Testing...")
    ...
    # 1. Locate the unencrypted Word Document
    await send_query(runner, "Locate the file test2.docx", session_id)
    
    # 2. Ask a specific content question (e.g., coffee preference)
    await send_query(runner, "Read its contents and tell me what this document says about coffee", session_id)
